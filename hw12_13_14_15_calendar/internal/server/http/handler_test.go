...
func TestHandler(t *testing.T) {
	config, err := configs.NewConfig("../../../configs/config_example.env")
	if err != nil {
	...
	handler := NewHandler(calendar, logg)
	hostPort := net.JoinHostPort(config.HttpHost, config.HttpPort)
	...
	t.Run("Create success", func(t *testing.T) {
		...
		r := httptest.NewRequest("POST", "http:"+u.String(), strings.NewReader(`
{
...
`))
	...
	t.Run("Update success", func(t *testing.T) {
		u := url.URL{Host: hostPort, Path: EventPath}
		r := httptest.NewRequest("PUT", "http:"+u.String(), strings.NewReader(`
{
    "id": 1,
	"title" :"title string API 13",
	"description" :        "description string API 13",
...
`))
	...
	t.Run("Read success", func(t *testing.T) {
		...
		require.Equal(t, http.StatusOK, resp.StatusCode)
		body, _ := ioutil.ReadAll(resp.Body)
		require.Equal(t, "{\"Id\":1,\"Title\":\"title string API 13\",\"Description\":\"description string API 13\",\"UserID\":1,\"StartDate\":\"2021-11-30T18:00:00Z\",\"EndDate\":\"2021-12-30T18:00:00Z\",\"NotificationDate\":\"2021-11-30T19:00:00Z\"}", string(body))
	})
